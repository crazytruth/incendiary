...
def _patch_redis_classes():
    ...
    _patch_obj_execute_command(redis.RedisConnection, True)

    # Patch the created pipelines.
    pipeline_method = redis.Redis.pipeline
    ...
    redis.RedisConnection.pipeline = tracing_pipeline

    # Patch the created pubsubs.
    # pubsub_method = redis.RedisConnection.pubsub
    ...
    #     return pubsub
    #
    # redis.Redis.pubsub = tracing_pubsub
