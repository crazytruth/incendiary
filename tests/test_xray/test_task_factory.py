...
from incendiary.xray.factories import tracing_task_factory, wrap_tracing_task_factory
...
class TestTaskFactory():
    ...
    async def wrap_task_factory(self):
        loop = asyncio.get_event_loop()
        loop.set_task_factory(wrap_tracing_task_factory(aiotask_context.chainmap_task_factory))
